{-
 ...
 -}
module CALL_BY_REF.Interp (interp,runInterp,prelude,Answer) where
...
import           CALL_BY_REF.Closure
import           CALL_BY_REF.Environment
import           CALL_BY_REF.Pair
import           CALL_BY_REF.Parser
import           CALL_BY_REF.Prelude
...
runInterp = do
    args <- getArgs
    if null args
        then putStrLn "CALL_BY_REF: Missing source file name"
